...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Spring Configuration Processor, Quartz Scheduler'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 quartz:0.0.1-SNAPSHOT
```
