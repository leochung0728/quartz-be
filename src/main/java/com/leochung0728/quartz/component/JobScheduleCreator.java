package com.leochung0728.quartz.component;
...
public class JobScheduleCreator {
	...
	public SimpleTrigger createSimpleTrigger(String triggerName, Date startTime, Long repeatInterval, int repeatCount,
			int misFireInstruction) {
