...
public class WebDetailEntryMASearch {
	...
	public WebDetailEntryMASearch() {
	}

	public WebDetailEntryMASearch(String link) {
		this.id = SecurityUtils.sha256(link);
		this.link = link;
	}
	
	public WebDetailEntryMASearch(String link, String name, String city, String district) {
		this(link);
		this.name = name;
		this.city = city;
